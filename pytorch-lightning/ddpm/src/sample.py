...
def infer(args):
    ...
    #     "../logs/ddpm-base/version_14/checkpoints/epoch=19-step=1280.ckpt"
    # ))
    # ddpm = LitDDPM.load_from_checkpoint("../logs/ddpm-base/version_16/checkpoints/epoch=19-step=1280.ckpt") -- stable
    ddpm = LitDDPM.load_from_checkpoint("../logs/ddpm-base/version_19/checkpoints/epoch=19-step=1280.ckpt")
    #print(ddpm.model.state_dict)
    # print(ddpm.model.state_dict)
    ...
    with torch.no_grad():
        sample(ddpm.model, scheduler, train_config, model_config, diffusion_config)
